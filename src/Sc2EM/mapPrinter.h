...
public:
	...
	void						Rectangle(Sc2Bindings::WalkPosition TopLeft, Sc2Bindings::WalkPosition BottomRight, Color col, fill_t fillMode = do_not_fill, dashed_t dashedMode = not_dashed);

	// This function will automatically crop the square so that it fits in the Map.
	void						Square(Sc2Bindings::WalkPosition Center, int radius, Color col, fill_t fillMode = do_not_fill);

	// This function will automatically crop the circle so that it fits in the Map.
	void						Circle(Sc2Bindings::WalkPosition Center, int radius, Color col, fill_t fillMode = do_not_fill);
