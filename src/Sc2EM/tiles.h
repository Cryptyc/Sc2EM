...
namespace BWEM {
	...
	public:
		...
		// is destroyed and BWEM is informed of that by a call of Map::OnMineralDestroyed(sc2::Unit u) for exemple. In such a case,
	...
	altitude_t minAltitudeTop(const Sc2Bindings::TilePosition & tile, const Map & theMap);
	altitude_t minAltitudeBottom(const Sc2Bindings::TilePosition & tile, const Map & theMap);
	altitude_t minAltitudeLeft(const Sc2Bindings::TilePosition & tile, const Map & theMap);
	altitude_t minAltitudeRight(const Sc2Bindings::TilePosition & tile, const Map & theMap);
	...
	namespace utils {
		...
		template<>
		struct TileOfPosition<Sc2Bindings::TilePosition>
		{
			typedef Tile type;
		};

		template<>
		struct TileOfPosition<Sc2Bindings::WalkPosition>
		{
		...
		{
			typedef Sc2Bindings::TilePosition type;
		};

		template<>
		struct PositionOfTile<MiniTile>
		{
			typedef Sc2Bindings::WalkPosition type;
		};
