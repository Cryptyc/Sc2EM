...
{
	namespace Colors {
		static const Color Orange = Color(255, 201, 14);
		static const Color Brown = Color(255, 0, 0);
		static const Color Cyan = Color(175, 238, 238);
		static const Color Grey = Color(83, 0, 0);
	}
}
...
namespace Sc2Bindings
{
	...
	static const sc2::Color BWToSc2Color(Color InColor)
	{
		switch (InColor)
		{

		case Colors::Red:
			return sc2::Colors::Red;

		case Colors::Blue:
			return sc2::Colors::Blue;

		case Colors::Teal:
			return sc2::Colors::Teal;

		case Colors::Purple:
			return sc2::Colors::Purple;
		case Colors::Orange:
			return sc2::Colors::Orange;
		case Colors::Brown:
			return sc2::Colors::Brown;
		case Colors::White:
			return sc2::Colors::White;
		case Colors::Yellow:
			return sc2::Colors::Yellow;
		case Colors::Green:
			return sc2::Colors::Green;
		case Colors::Cyan:
			return sc2::Colors::Cyan;
		case Colors::Black:
			return sc2::Colors::Black;
		case Colors::Grey:
			return sc2::Colors::Grey;
		}
		return sc2::Colors::Black;
	}
